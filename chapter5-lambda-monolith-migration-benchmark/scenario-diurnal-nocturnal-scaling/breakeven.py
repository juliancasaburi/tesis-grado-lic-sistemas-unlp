...
LAMBDA_EXECUTION_TIME_MS = 104 # Execution time in milliseconds
...
EC2_HA_MONTHLY_COST_RESERVED = 9.49  # t3.small instance cost for reserved EC2
EC2_HA_MONTHLY_COST_ON_DEMAND = 15.18  # t3.small instance cost for on-demand EC2
